...
#This is the basic code for the main window. I had to resize the image so it wouldn't overwhelm the screen.

root = Tk()
root.geometry("700x500")
root.title("Age Calculator")
#photo = ImageTk.PhotoImage(Image.open("/Users/rebekahgrelen/Desktop/GitProjects/Age-Calculator/newcalculator.jpg"))
